...
const Education = () => {
  ...
  return (
    <section id="education" className="py-12 sm:py-16 md:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
          {education.map((edu, index) => (
            <div key={index} className="border-b border-border pb-5 sm:pb-6 last:border-b-0 hover:bg-muted/20 transition-smooth p-3 sm:p-4 rounded-lg click-effect">
