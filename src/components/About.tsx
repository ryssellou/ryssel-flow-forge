    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="prose prose-lg max-w-3xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          {highlights.map((highlight, index) => {
            ...
            return (
              <Card key={index} className="p-5 sm:p-6 md:p-8 text-center hover:shadow-lg transition-all duration-300 hover:scale-105 border border-border bg-card/50 backdrop-blur-sm">
