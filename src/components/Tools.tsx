...
import claudeCodeLogo from "@/assets/antigravity-logo.png";
import antigravityLogo from "@/assets/claude-code-logo.png";
...
const Tools = () => {
  ...
  return (
    <section id="tools" className="py-16 sm:py-20 md:py-24 bg-section-bg overflow-hidden">
